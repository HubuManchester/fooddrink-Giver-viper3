    ...
    public class DatabaseService
    {
        ...
        private static async Task SeedDataAsync(SQLiteAsyncConnection db)
        {
            ...
            var items = new List<FoodItem>
            {
                ...
                new() { Name = "Kung Pao Chicken",        Subtitle = "Sichuan", ImageUrl = "kung_pao_chicken.png", Description = "Tender diced chicken wok-fried with golden peanuts, dried chilies, and Sichuan peppercorns in a savory-sweet soy-vinegar sauce. A global Chinese food icon.", Price = 11.99m, PriceTier = "$$", Rating = 4.8, ReviewCount = 445, CategoryId = 7, Cuisine = "Chinese", Distance = 0.8, Calories = 480, Allergens = "Peanut,Soy", AvailableTime = "10:30 AM - 9:30 PM", IsTrending = true, IsPopular = true, IsRecommended = true, CreatedAt = now },
            };

            // Stagger CreatedAt timestamps (10 min apart, spanning ~5 hours)
